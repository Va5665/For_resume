...
class CagStatistics_1:
    ...
    def save_content_to_database(self, list_all_status_serial, list_all_status_season, list_all_status_seria):
        try:
...
cag_stats = CagStatistics_1()
cag_stats.get_all_content_2()
