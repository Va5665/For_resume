...
class CagStatistics_2_1:
    def __init__(self, page=22, size=10):
        self.page = page
        self.size = size
        ...
        while has_more_pages:
            ...
            async with session.post(
                ...
                try:
                    ...
                    if not content_type.startswith('application/json'):
                        ...
                        for content in json_response_serial.get('elements', []):
                            ...
                            print(f"Время отправки запроса: {request_start_time}")
                            print(f"Время получения ответа: {response_end_time}")
                            print(f"Время выполнения запроса: {request_duration} секунд")
                ...
                if response_times:
                    ...
                    print(f"Среднее время ответа сервера: {avg_response_time} секунд")
